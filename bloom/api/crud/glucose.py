...
from api.models.glucose import Glucose as GlucoseModel
from api.schemas.glucose import GlucoseCreate, GlucoseUpdate
from typing import Union, Dict, Any
from fastapi.encoders import jsonable_encoder
class CRUDGlucose(CRUDBase[GlucoseModel, GlucoseCreate, GlucoseUpdate]):
    async def create(
    ...
    async def update(
        ...
        *,
        db_obj: GlucoseModel,
        obj_in: Union[GlucoseUpdate, Dict[str, Any]]
    ) -> GlucoseModel:
...
glucose = CRUDGlucose(GlucoseModel) 
